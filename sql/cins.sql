...
insert into okresy_dziejow values('BT', 'B', 'EPOKA BRĄZU', 'ŚRODKOWA', 'ŚRODKOWA', 'ŚROD. EP. BRĄZU');
insert into okresy_dziejow values('BM', 'B', 'EPOKA BRĄZU', 'MŁODSZA', 'MŁODSZA', 'MŁ. EP. BRĄZU');
insert into okresy_dziejow values('BP', 'B', 'EPOKA BRĄZU', 'PÓŹNA', 'PÓŹNA', 'PÓŹNY BRĄZ');
insert into okresy_dziejow values('B1', 'B', 'EPOKA BRĄZU', 'I', 'I', 'I EB');
insert into okresy_dziejow values('B2', 'B', 'EPOKA BRĄZU', 'II', 'II', 'II EB');
insert into okresy_dziejow values('B3', 'B', 'EPOKA BRĄZU', 'III', 'III', 'III EB');
insert into okresy_dziejow values('B4', 'B', 'EPOKA BRĄZU', 'IV', 'IV', 'IV EB');
insert into okresy_dziejow values('B5', 'B', 'EPOKA BRĄZU', 'V', 'V', 'V EB');
insert into okresy_dziejow values('BA', 'B', 'EPOKA BRĄZU', 'A', 'A', 'EB A');
insert into okresy_dziejow values('BB', 'B', 'EPOKA BRĄZU', 'B', 'B', 'EB B');
insert into okresy_dziejow values('BC', 'B', 'EPOKA BRĄZU', 'C', 'C', 'EB C');
insert into okresy_dziejow values('BD', 'B', 'EPOKA BRĄZU', 'D', 'D', 'EB D');
insert into okresy_dziejow values('BH', 'B', 'EPOKA BRĄZU', 'OKRES HALSZTACKI', 'OKRES HALSZTACKI', 'HALSZTACKI');
insert into okresy_dziejow values('BL', 'B', 'EPOKA BRĄZU', 'OKRES HALSZTACKI A', 'OKRES HALSZTACKI A', 'HA A');
insert into okresy_dziejow values('BN', 'B', 'EPOKA BRĄZU', 'OKRES HALSZTACKI B', 'OKRES HALSZTACKI B', 'HA B');
insert into okresy_dziejow values('Z', 'Z', 'EPOKA ŻELAZA', NULL, 'EPOKA ŻELAZA', 'EP. ŻELAZA');
insert into okresy_dziejow values('ZW', 'Z', 'EPOKA ŻELAZA', 'WCZESNA', 'WCZESNA', 'WCZES. EP. ŻELAZA');
insert into okresy_dziejow values('Z6', 'Z', 'EPOKA ŻELAZA', 'VI', 'VI', 'EB VI');
insert into okresy_dziejow values('ZH', 'Z', 'EPOKA ŻELAZA', 'OKRES HALSZTACKI', 'OKRES HALSZTACKI', 'HALSZTACKI');
...
insert into okresy_dziejow values('ZY', 'Z', 'EPOKA ŻELAZA', 'PÓŹNY OKRES WPŁYWÓW RZYMSKICH', 'PÓŹNY OKRES WPŁYWÓW RZYMSKICH', 'PÓŹ. OWR'); --
